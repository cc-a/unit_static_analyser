...
def test_unit_from_string_simple():
    """Test parsing a simple unit string and its string representation."""
...
def test_unit_from_string_power():
    """Test parsing string with negative exponent and its str."""
...
def test_unit_from_string_multiplication():
    """Test parsing compound unit with multiplication and its str."""
...
def test_unit_equality():
    """Test equality and inequality comparisons between Unit instances."""
...
def test_unit_multiplication():
    """Test multiplication of two Unit instances and the resulting unit."""
...
def test_unit_power():
    """Test raising a Unit instance to a power."""
...
def test_unit_zero_exponent_removed():
    """Test that multiplying units cancels exponents to zero and removes them."""
    u = Unit.from_string("m.s^-1")
...
def test_unit_invalid_string():
    """Test that parsing an invalid unit string raises a ValueError."""
    with pytest.raises(ValueError):
        Unit.from_string("m//s")


def test_unit_repr_and_str():
    """Test the __str__ and __repr__ representations of a Unit instance."""
    u = Unit.from_string("kg.m^2.s^-2")
    s = str(u)
    r = repr(u)
    assert "kg" in s and "m^2" in s and "s^-2" in s
